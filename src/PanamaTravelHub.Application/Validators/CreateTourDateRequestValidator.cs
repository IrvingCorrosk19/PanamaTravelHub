...
public class CreateTourDateRequestValidator : AbstractValidator<CreateTourDateRequestDto>
{
    public CreateTourDateRequestValidator()
    {
        RuleFor(x => x.TourDateTime)
            .NotEmpty().WithMessage("La fecha y hora del tour es requerida")
